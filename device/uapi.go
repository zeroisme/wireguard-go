...
func (device *Device) handleDeviceLine(key, value string) error {
	...
	case "private_key":
		...
		device.verbosef("UAPI: Updating private key")
	...
	case "listen_port":
		...
		device.verbosef("UAPI: Updating listen port")
	...
	case "fwmark":
		...
		device.verbosef("UAPI: Updating fwmark")
	...
	case "replace_peers":
		...
		device.verbosef("UAPI: Removing all peers")
...
func (device *Device) handlePublicKeyLine(peer *ipcSetPeer, value string) error {
	...
	if peer.created {
		...
		device.verbosef("%v - UAPI: Created", peer.Peer)
	}
	return nil
}
...
func (device *Device) handlePeerLine(peer *ipcSetPeer, key, value string) error {
	...
	case "remove":
		...
		if !peer.dummy {
			device.verbosef("%v - UAPI: Removing", peer.Peer)
			device.RemovePeer(peer.handshake.remoteStatic)
		}
		peer.Peer = &Peer{}
		peer.dummy = true
	...
	case "preshared_key":
		device.verbosef("%v - UAPI: Updating preshared key", peer.Peer)
	...
	case "endpoint":
		device.verbosef("%v - UAPI: Updating endpoint", peer.Peer)
	...
	case "persistent_keepalive_interval":
		device.verbosef("%v - UAPI: Updating persistent keepalive interval", peer.Peer)
	...
	case "replace_allowed_ips":
		device.verbosef("%v - UAPI: Removing all allowedips", peer.Peer)
		if value != "true" {
	...
	case "allowed_ip":
		device.verbosef("%v - UAPI: Adding allowedip", peer.Peer)
