...
func deviceUpdateState(device *Device) {
	...
	case true:
		if err := device.BindUpdate(); err != nil {
			device.Error("Unable to update bind:", err)
...
func NewDevice(tunDevice tun.Device, logger *Logger) *Device {
	...
	if err != nil {
		device.Error("Trouble determining MTU, assuming default:", err)
		mtu = DefaultMTU
	}
...
func (device *Device) BindUpdate() error {
	...
	if device.isUp.Get() {
		...
		device.Debug("UDP bind has been updated")
	}
